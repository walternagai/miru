...
MESSAGES: dict[str, dict[str, str]] = {
    "en_US": {
        ...
        # Renderer output
        "renderer.no_models": "No models installed.",
        "renderer.no_models_hint": "Use: miru pull <model>",
        "renderer.available_models": "Available models",
        "renderer.model_column": "Model",
        "renderer.size_column": "Size",
        "renderer.modified_column": "Modified",
        "renderer.models_count": "{count} model(s) available",
        "renderer.identification": "Identification",
        "renderer.families": "Families",
        "renderer.parameters": "Parameters",
        "renderer.quantization": "Quantization",
        "renderer.capabilities": "Capabilities",
        "renderer.vision": "Vision",
        "renderer.yes": "yes",
        "renderer.no": "no",
        "renderer.max_context": "Max context",
        "renderer.default_params": "Default parameters",
        "renderer.pulling_manifest": "Retrieving manifest...",
        "renderer.downloading": "Downloading",
        "renderer.verifying": "Verifying integrity...",
        "renderer.downloaded_success": "{model} downloaded successfully.",
        "renderer.compare_title": "Model Comparison",
        "renderer.compare_model_column": "Model",
        "renderer.compare_tokens_column": "Tokens",
        "renderer.compare_time_column": "Time",
        "renderer.compare_speed_column": "Speed",
        "renderer.compare_no_seed_warning": "Without --seed: results may vary between runs.",
        "renderer.compare_no_seed_hint": "For reproducible comparison: miru compare ... --seed 42",
        "renderer.generating": "Generating response",
    ...
    "pt_BR": {
        ...
        # Renderer output
        "renderer.no_models": "Nenhum modelo instalado.",
        "renderer.no_models_hint": "Use: miru pull <model>",
        "renderer.available_models": "Modelos disponíveis",
        "renderer.model_column": "Modelo",
        "renderer.size_column": "Tamanho",
        "renderer.modified_column": "Modificado",
        "renderer.models_count": "{count} modelo(s) disponível(is)",
        "renderer.identification": "Identificação",
        "renderer.families": "Família(s)",
        "renderer.parameters": "Parâmetros",
        "renderer.quantization": "Quantização",
        "renderer.capabilities": "Capacidades",
        "renderer.vision": "Visão",
        "renderer.yes": "sim",
        "renderer.no": "não",
        "renderer.max_context": "Contexto máximo",
        "renderer.default_params": "Parâmetros padrão",
        "renderer.pulling_manifest": "Obtendo manifesto...",
        "renderer.downloading": "Baixando",
        "renderer.verifying": "Verificando integridade...",
        "renderer.downloaded_success": "{model} baixado com sucesso.",
        "renderer.compare_title": "Comparação de Modelos",
        "renderer.compare_model_column": "Modelo",
        "renderer.compare_tokens_column": "Tokens",
        "renderer.compare_time_column": "Tempo",
        "renderer.compare_speed_column": "Velocidade",
        "renderer.compare_no_seed_warning": "Sem --seed: resultados podem variar entre execuções.",
        "renderer.compare_no_seed_hint": "Para comparação reproduzível: miru compare ... --seed 42",
        "renderer.generating": "Gerando resposta",
    ...
    "es_ES": {
        ...
        # Renderer output
        "renderer.no_models": "Ningún modelo instalado.",
        "renderer.no_models_hint": "Use: miru pull <model>",
        "renderer.available_models": "Modelos disponibles",
        "renderer.model_column": "Modelo",
        "renderer.size_column": "Tamaño",
        "renderer.modified_column": "Modificado",
        "renderer.models_count": "{count} modelo(s) disponible(s)",
        "renderer.identification": "Identificación",
        "renderer.families": "Familias",
        "renderer.parameters": "Parámetros",
        "renderer.quantization": "Cuantización",
        "renderer.capabilities": "Capacidades",
        "renderer.vision": "Visión",
        "renderer.yes": "sí",
        "renderer.no": "no",
        "renderer.max_context": "Contexto máximo",
        "renderer.default_params": "Parámetros por defecto",
        "renderer.pulling_manifest": "Obteniendo manifiesto...",
        "renderer.downloading": "Descargando",
        "renderer.verifying": "Verificando integridad...",
        "renderer.downloaded_success": "{model} descargado exitosamente.",
        "renderer.compare_title": "Comparación de Modelos",
        "renderer.compare_model_column": "Modelo",
        "renderer.compare_tokens_column": "Tokens",
        "renderer.compare_time_column": "Tiempo",
        "renderer.compare_speed_column": "Velocidad",
        "renderer.compare_no_seed_warning": "Sin --seed: los resultados pueden variar entre ejecuciones.",
        "renderer.compare_no_seed_hint": "Para comparación reproducible: miru compare ... --seed 42",
        "renderer.generating": "Generando respuesta",
